...
async function onSubmit(e) {
  ...
  try {
    ...
    toast.success("Password was send")
  } catch (error) {
          ...
          <form onSubmit={onSubmit}>
            <input 
              ...
              <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
                <p className='mb-6'>Don't have an account? <Link to="/sign-up" className='text-red-600 hover:text-red-700 transition duration-200 ease-in-out ml-1'>Register</Link>
                </p>
                <p>
                  <Link to="/sign-in"
